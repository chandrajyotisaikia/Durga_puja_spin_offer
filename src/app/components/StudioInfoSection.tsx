          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <div className="p-6 md:p-8 border-b md:border-b-0 md:border-r border-primary/20">
              ...
              <div className="space-y-1 pl-1">
                <p className="text-accent font-bold text-base font-display uppercase tracking-wide">Ground Floor, Raja Complex</p>
                <p className="text-muted-foreground text-sm">Beltola - Basistha Rd, near Shiv Mandir</p>
                <p className="text-muted-foreground text-sm">Beltola Tiniali, Guwahati</p>
                <p className="text-muted-foreground text-xs mt-2 uppercase tracking-wider">Assam 781028, India</p>
              </div>
            </div>
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="flex items-center gap-4 mt-2">
                ...
                <a
                  ...
                  aria-label="Call us"
                  className="w-12 h-12 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:opacity-90"
                ...
                {/* Instagram */}
                <a
                  href="https://www.instagram.com/inkfinitytattooandpiercing"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* Facebook */}
                <a
                  href="https://www.facebook.com/inkfinitytattooandpiercing"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Facebook"
                  className="w-12 h-12 rounded-full flex items-center justify-center transition-all hover:scale-110 hover:opacity-90"
